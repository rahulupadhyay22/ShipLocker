...
class ParcelAdmin(admin.ModelAdmin):
    list_display = ['display_id', 'locker', 'status', 'item_name', 'weight_kg', 'received_at']
    ...
    actions = ['mark_action_required', 'mark_approved']
    
    @admin.action(description='Mark as Action Required')
...
class ReturnRequestAdmin(admin.ModelAdmin):
    list_display = ['parcel', 'status', 'requested_at', 'processed_at']
    list_filter = ['status']
    search_fields = ['parcel__locker__locker_id']
    raw_id_fields = ['parcel']
...
class DiscardRequestAdmin(admin.ModelAdmin):
    list_display = ['parcel', 'status', 'requested_at', 'discarded_at']
    list_filter = ['status']
    search_fields = ['parcel__locker__locker_id']
    raw_id_fields = ['parcel']
    readonly_fields = ['requested_at']
