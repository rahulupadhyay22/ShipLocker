...
urlpatterns = [
    ...
    path('data-export/', views.AccountDataExportView.as_view(), name='data_export'),
    path('delete/', views.AccountDeletionRequestView.as_view(), name='delete_account'),
    path('subscription/', views.SubscriptionSavingsView.as_view(), name='subscription'),
