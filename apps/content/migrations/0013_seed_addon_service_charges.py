...
ADDON_CHARGES = [
    {
        'code': 'addon_insurance', 'name': 'Insurance',
        'description': "Protect your shipment's full declared value against loss or damage. 2% of declared value, minimum ₹99.",
        'charge_type': 'percentage', 'percentage_rate': '2.00', 'amount': '99.00',
    },
    {
        'code': 'addon_extra_photos', 'name': 'Extra Photos',
    ...
    {
        'code': 'addon_priority_packing', 'name': 'Priority Packing',
        'description': 'Jump the queue — your shipment gets packed first. Flat ₹299.',
        'charge_type': 'flat', 'percentage_rate': None, 'amount': '299.00',
    },
    {
        'code': 'addon_gift_wrapping', 'name': 'Gift Wrapping',
        'description': 'Have your shipment gift-wrapped before it ships. Flat ₹99.',
